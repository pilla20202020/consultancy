        ...
        @if (isset($student->languages) && $student->languages->isEmpty() == false)
            @foreach ($student->languages as $language)
                <div class="form-group d-flex align-items-end">.
                    ...
                    <div class="col-md-1">
                        <a href="{{ asset('storage/'.$language->language_documents) }}" target="__blank">
                            View Uploaded File
                        </a>
                    </div>

                    <div class="col-md-1" style="margin-top: 45px;">
                        <a href="{{route('admission.delete_commission',$language->id)}}" class="btn btn-sm btn-danger mr-1 p-2" type="submit" value=""><i class="far fa-trash-alt"></i></a>
                    </div>
                </div>
            @endforeach
        @endif
