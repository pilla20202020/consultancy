            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('email', isset($branch->email) ? $branch->email : '') }}" placeholder="Enter a email" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    ...
                                    value="{{ old('phone', isset($branch->phone) ? $branch->phone : '') }}" placeholder="Enter a Phone" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group ">
                                <label for="phone" class="col-form-label pt-0">Address</label>
                                <div class="">
                                    <input class="form-control" type="text" name="address"
                                    value="{{ old('phone', isset($branch->address) ? $branch->address : '') }}" placeholder="Enter a Address" required>
                                </div>
                            </div>
                        </div>
                    </div>
