...
class AddFieldRolesPermission extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('roles', function (Blueprint $table) {
            ...
            $table->foreign('last_deleted_by')->references('users_id')->on('tbl_users')->onUpdate('cascade')->onDelete('cascade');
        });
        ...
        Schema::create('role_user', function (Blueprint $table) {
            ...
            $table->foreign('role_id')->references('users_id')->on('tbl_users')->onDelete('cascade');
            $table->bigInteger('user_id')->unsigned()->index();
            $table->foreign('user_id')->references('users_id')->on('tbl_users')->onDelete('cascade');
            $table->timestamps();
        });
    }
